...
class Ui_Reminder_Window(object):
    def setupUi(self, Reminder_Window):
        ...
        Reminder_Window.resize(400, 340)
...
"}")
        ...
        self.less_options_button.setGeometry(QtCore.QRect(150, 320, 111, 31))
...
"}")
        ...
        self.add_button.setGeometry(QtCore.QRect(230, 260, 131, 41))
...
"}")
        ...
        self.cancel_button.setGeometry(QtCore.QRect(40, 260, 131, 41))
...
"}")
        ...
        self.label_2.setGeometry(QtCore.QRect(220, 100, 68, 17))
...
"}")
        ...
        self.repetition_label.setGeometry(QtCore.QRect(60, 180, 91, 31))
...
"}")
        ...
        self.event_title_edit.setGeometry(QtCore.QRect(10, 30, 361, 41))
...
"}")
        ...
        self.reminder_label.setGeometry(QtCore.QRect(60, 230, 81, 20))
...
"}")
        ...
        self.target_date_edit.setGeometry(QtCore.QRect(39, 120, 121, 31))
...
"}")
        ...
        self.target_time_edit.setGeometry(QtCore.QRect(220, 120, 118, 31))
...
"}")
        ...
        self.repetition_options.setGeometry(QtCore.QRect(180, 180, 141, 24))
        ...
        self.more_options_button.setGeometry(QtCore.QRect(130, 180, 121, 31))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(40, 100, 68, 17))
        self.label.setStyleSheet("QLabel\n"
"{\n"
"    font: 11pt \"Roboto\";\n"
"}")
        self.label.setObjectName("label")
        self.less_options_button_2 = QtWidgets.QCommandLinkButton(Reminder_Window)
        self.less_options_button_2.setGeometry(QtCore.QRect(140, 280, 111, 31))
        self.less_options_button_2.setStyleSheet("QCommandLinkButton\n"
"{\n"
"    font: 11pt \"Roboto\";\n"
"    text-decoration: underline;\n"
"    \n"
...
"    qproperty-icon : None\n"
"}")
        self.less_options_button_2.setObjectName("less_options_button_2")
        self.reminder_options = QtWidgets.QComboBox(Reminder_Window)
        self.reminder_options.setGeometry(QtCore.QRect(180, 230, 141, 27))
    ...
    def retranslateUi(self, Reminder_Window):
        ...
        Reminder_Window.setWindowTitle(_translate("Reminder_Window", "Form"))
        ...
        self.less_options_button_2.setText(_translate("Reminder_Window", "Less Options?"))
